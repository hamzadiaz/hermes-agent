...
SESSION_SEARCH_GUIDANCE = (
    ...
    "For recency questions like 'what were we just working on', 'where are we', "
    "'what was the latest issue', or 'what did we just discuss', prefer the most "
    "recent relevant session/transcript context first. Use long-term memory as "
    "supporting background, not the primary source, unless the user explicitly asks "
    "for broader history."
)
